...
; Simple read/write completed	
ReadError1:	; Calls IN before OUT
	LOAD	One
	IN		SRAM_R00
	STORE	ReadVal
	
ReadError2:	; Calls OUT twice
	LOAD	Two
	STORE	Temp
	LOAD	One
	OUT		SRAM_R00
...
ReadError3:	; Call OUT Rxy then IN Rzw
	LOAD	One
	OUT		SRAM_R00
	IN		SRAM_R01
	STORE	ReadVal
	
ReadError4:	; Call OUT WAxx instead of OUT Rxx
	LOAD	One
	OUT		SRAM_WA00
	IN		SRAM_R00
	LOAD	One
...
WriteError1: ; Call	OUT WD before OUT WA
	LOAD	Five
	OUT		SRAM_WD00
	LOAD	One
	OUT		SRAM_WA00
...
WriteError3: ; Call OUT R instead of OUT WA
	Load	Two
	OUT		SRAM_R00
	Load	Six
	OUT		SRAM_WD00
...
WriteError4: ; Call IN WD instead of OUT WD
	LOAD	Two
	OUT		SRAM_WA00
	LOAD	Three
	IN		SRAM_WD00
